...
export default function Edit() {
  ...
  return (
    <div style={{ width: "1296px", height: "100vh" }} className='d-flex justify-content-center align-items-center'>
      <Form style={{ width: "480px", height: "480px" , backgroundColor:'lightgreen',textAlign:'center' }} onSubmit={formik.handleSubmit}>
        <h1 className='mb-4 text-success' style={{color:'brown',textDecoration:'underline'}}>Edit The Existing Data</h1>
        ...
        <Button style={{background:'pink', color:'red'}} type="submit">Update form</Button>
      </Form>
    </div>
  )
}